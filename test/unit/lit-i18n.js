...
class I18nFull extends HTMLElement {
  ...
  get renderTemplate() {
    return html`
      ...
      <div
        class="title-interpolation"
        title="${t("whatishow", { what: "i18next", how: "great" })}"
      ></div>
...
const addElement = tag => {
  return elements[
    elements.push(document.body.appendChild(document.createElement(tag || "i18n-test"))) - 1
  ];
};
